...
@InitiatedBy(EndUserSuspendOrActiveOrSwithAccountTypeFlowInitiator.class)
public class EndUserSuspendOrActiveOrSwithAccountTypeFlowAcceptor extends FlowLogic<Void> {
    private final FlowSession otherPartySession;

    public EndUserSuspendOrActiveOrSwithAccountTypeFlowAcceptor(FlowSession otherPartySession) {
