...
@InitiatedBy(RegulateurDeviseCreatorFlowInitiator.class)
public class RegulateurDeviseCreatorAcceptor extends FlowLogic<Void> {
    private final FlowSession otherPartySession;

    public RegulateurDeviseCreatorAcceptor(FlowSession otherPartySession) {
            ...
            protected void checkTransaction(SignedTransaction stx) {
                requireThat(require -> {
                    ...
                    require.using("Ce n'est pas une transaction d'enregistrement d'un regulateur .",
                            output instanceof RegulateurDeviseStates);
                    return null;
                });
            }
        }
