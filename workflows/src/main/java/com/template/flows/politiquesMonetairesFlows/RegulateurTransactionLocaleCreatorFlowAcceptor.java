...
@InitiatedBy(RegulateurTransactionLocaleCreatorFlowInitiator.class)

public class RegulateurTransactionLocaleCreatorFlowAcceptor extends FlowLogic<Void> {
    private final FlowSession otherPartySession;

    public RegulateurTransactionLocaleCreatorFlowAcceptor(FlowSession otherPartySession) {
            ...
            protected void checkTransaction(SignedTransaction stx) {
                requireThat(require -> {
                    ...
                    require.using("Ce n'est pas une transaction d'enregistrement d'un regulateur .",
                            output instanceof RegulateurTransactionLocaleStates);
                    return null;
                });
            }
        }
