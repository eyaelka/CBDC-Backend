...
@InitiatedBy(RegulateurMasseMonnetaireCreatorFlowInitiator.class)
public class RegulateurMasseMonnetaireCreatorFlowAcceptor extends FlowLogic<Void> {
    private final FlowSession otherPartySession;

    public RegulateurMasseMonnetaireCreatorFlowAcceptor(FlowSession otherPartySession) {
            ...
            protected void checkTransaction(SignedTransaction stx) {
                requireThat(require -> {
                    ...
                    require.using("Ce n'est pas une transaction d'enregistrement d'un regulateur .",
                            output instanceof RegulateurMasseMonnetaireStates);
                    return null;
                });
            }
        }
