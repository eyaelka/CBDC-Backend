 ...
 */
public class CommercialBankAuthenticationFilter extends UsernamePasswordAuthenticationFilter{

    private AuthenticationManager authenticationManager;

    public CommercialBankAuthenticationFilter(AuthenticationManager authenticationManager) {
        super();
